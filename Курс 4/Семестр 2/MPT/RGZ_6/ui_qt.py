...
class UniversalCalculator(QMainWindow):
    ...
    def init_ui(self):
        ...
        toolbar = QToolBar("Основание")
        self.addToolBar(toolbar)
        toolbar.addWidget(QLabel("Основание СС:"))
        self.base_spin = QSpinBox()
        self.base_spin.setMinimum(2)
        self.base_spin.setMaximum(16)
        self.base_spin.setValue(10)
        self.base_spin.valueChanged.connect(self.change_base)
        toolbar.addWidget(self.base_spin)
